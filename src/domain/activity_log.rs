...
/// (see docs/archived/archived_issues_and_features.md's "unify completion-undo" note) any other top-level completion,
...
pub struct ActivityLogEntry {
    ...
    /// `docs/archived/archived_issues_and_features.md`'s "unify completion-undo" note and the
