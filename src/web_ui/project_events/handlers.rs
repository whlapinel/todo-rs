...
/// functions — mirrors `project_tasks::handlers::save_project_task_as_template`'s identical
/// rationale (no `create_project_template` service function exists yet — that's stage
/// B5d's job).
